...
- Search: your own pins by title, tag, label or folder, and your tracks by name or year — or paste `27.74367, -15.58338`, or the degrees-minutes-seconds a map site gives you, and fly there with the option to keep the spot as a pin. Read-only, so it needs no token
